...
**مصدر الدمج:** `prototype/king-khalid-racecourse/` — نسخة **V2.1** المحاذاة فوتوغرافياً
...
| `reference/kkrc_aerial_reference.jpg` + `reference_alignment.json` | المرجع الفوتوغرافي (800×533) وقيم محاذاته الموثقة (`photo_verified: true`) | صفر |
...
| ميزانية موبايل أضيق | هبوط FPS | مقاس (V2.1): 51–83 calls / ~54k tris حسب الكاميرا؛ خفض جاهز عبر ثوابت المناطق (نخيل/شجيرات/مدينة) وتعطيل الظلال |
| بقايا الإسقاط المائل للمرجع | انحراف ~25–35م بالربع الشمالي-الغربي | موثق في تقرير V2.1؛ يُحسم بلقطة عمودية أو قياسات مساحية ثم تحريك نقاط التحكم وإعادة التصدير |
...
4. مطابقة بصرية ضد لقطات `reports/kkrc-v2.1/` (الاعتماد الفوتوغرافي) و`reports/kkrc-v2/` (نفس المراسي = مقارنة مباشرة).
